...
for (i in seq_along(sp_data_list)) {
  ...
  file.copy(
    ...
    to =
      paste0("data/workflow_maxent/", sp_name, "/Model_calibration/M_variables/Set_1/bio", bios_lcor, ".asc")
  )
  ...
  file.copy(
    from = paste0(
      "data/workflow_maxent/", sp_name, "/pcas/pca_referenceLayers/PC0", nums, ".asc"
      ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/Model_calibration/M_variables/Set_2/PC0", nums, ".asc"
      )
  )
  ...
  file.copy(
    from = paste0(
      "data/workflow_maxent/", sp_name, "/Model_calibration/M_variables/Set_1/bio", bios_lcor, ".asc"
    ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_1/Current/bio", bios_lcor, ".asc"
    )
  )
  
  # select only future low corr variable
  dir_create(paste0("data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_mc_126_60"))

  file.copy(
    from = paste0(
      "data/future_layer_mc_126_60/bio", bios_lcor, ".asc"
    ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_mc_126_60/bio", bios_lcor, ".asc"
    )
  )

  dir_create(paste0("data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_mc_585_60"))

  file.copy(
    from = paste0(
      "data/future_layer_mc_585_60/bio", bios_lcor, ".asc"
    ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_mc_585_60/bio", bios_lcor, ".asc"
    )
  )

  dir_create(paste0("data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_can_126_60"))

  file.copy(
    from = paste0(
      "data/future_layer_can_126_60/bio", bios_lcor, ".asc"
    ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_can_126_60/bio", bios_lcor, ".asc"
    )
  )

  dir_create(paste0("data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_can_585_60"))

  file.copy(
    from = paste0(
      "data/future_layer_can_585_60/bio", bios_lcor, ".asc"
    ),
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_1/future_layer_can_585_60/bio", bios_lcor, ".asc"
    )
  )
  ...
  file.copy(
    ...
    to = paste0(
      "data/workflow_maxent/", sp_name, "/G_Variables/Set_2/Current/PC0", nums, ".asc"
    )
  )
}
